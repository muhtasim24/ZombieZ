...
def dodge_test1():
	...
	# the screen (y == 0) when player.dodge("up") is called
	...
	if new_location[1] > old_location[1]:
		print("TEST DODGE_1W FAILED: Player position did not move towards top of screen.")
		failed += 1
	elif new_location[0] != old_location[0]:
		print("TEST DODGE_1W FAILED: Player moved in x direction when it shouldn't have.")
		failed += 1
	else:
		print("TEST DODGE_1W PASSED!")
		passed += 1

	# Assert that player location moves towards the bottom of
	# the screen (y == screen_height) when player.dodge("down") is called
	...
	if new_location[1] < old_location[1]:
		print("TEST DODGE_1S FAILED: Player position did not move towards bottom of screen.")
		failed += 1
	elif new_location[0] != old_location[0]:
		print("TEST DODGE_1S FAILED: Player moved in x direction when it shouldn't have.")
		failed += 1
	else:
		print("TEST DODGE_1S PASSED!")
		passed += 1

	# Assert that player location moves towards the left side of
	# the screen (x == 0) when player.dodge("left") is called
	...
	if new_location[0] > old_location[0]:
		print("TEST DODGE_1A FAILED: Player position did not move towards left of screen.")
		failed += 1
	elif new_location[1] != old_location[1]:
		print("TEST DODGE_1A FAILED: Player moved in y direction when it shouldn't have.")
		failed += 1
	else:
		print("TEST DODGE_1A PASSED!")
		passed += 1

	# Assert that player location moves towards the right side of
	# the screen (x == screen_width) when player.dodge("right") is called
	...
	if new_location[0] < old_location[0]:
		print("TEST DODGE_1D FAILED: Player position did not move towards right of screen.")
		failed += 1
	elif new_location[1] != old_location[1]:
		print("TEST DODGE_1D FAILED: Player moved in y direction when it shouldn't have.")
		failed += 1
	else:
		print("TEST DODGE_1D PASSED!")
		passed += 1
