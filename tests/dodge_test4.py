...
def dodge_test4():
	...
	# Assert that player cannot take damage while its state is "dodging"
	player1 = player.Player(screen_center,health,health,damage,speed,screen)
	player1.state = "dodging"
	retval = player1.damageSelf(10) #should return False
	if retval:
		print("TEST DODGE_4 FAILED: Player was able to take damage while dodging.")
		failed += 1
	else:
		print("TEST DODGE_4 PASSED!")
		passed += 1
